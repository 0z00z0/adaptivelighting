...
> ```
>
> Latest release: **2026.9.11**, on the feed above. Omit the version to take whatever is newest.
...
internal sealed class AdaptiveLightingApp : IAsyncDisposable
{
    ...
    public AdaptiveLightingApp(LightingEngineHost engine, IHaContext ha,
                               IHaRegistry registry, IScheduler scheduler, ICurrentApp currentApp)
    {
        _engine = engine;
