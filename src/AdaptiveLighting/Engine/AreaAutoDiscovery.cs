...
/// </summary>
/// <remarks>
///     An area qualifies only with at least one light and at least one motion sensor. Only
///     <see cref="AreaConfig.AreaId"/> and <see cref="AreaConfig.Enabled"/> are written; everything else resolves
///     at run time, so a proposal survives a rename.
/// </remarks>
public static class AreaAutoDiscovery
{
	/// <summary>The areas worth proposing for this instance, in registry order, each switched off.</summary>
	...
	/// </summary>
	/// <remarks>Only ever sets a flag on. Everything untouched keeps following <c>Defaults</c>.</remarks>
