...
public static class TokenFormat
{
	...
	// Through DisplayRounding.Whole, which is also what the editor shows and what the next save stores: three
	...
	public static string PeriodLevel(TimePeriodConfig period)
	{
		...
		return string.Create(CultureInfo.InvariantCulture,
			$"{DisplayRounding.Whole(period.BrightnessPct)}% · {period.ColorTempKelvin}K");
	}
}
