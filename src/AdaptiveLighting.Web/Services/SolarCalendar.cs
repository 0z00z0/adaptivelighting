...
/// <summary>How the sun behaves relative to a chosen zenith angle on a given day.</summary>
/// <remarks>
///     The hour-angle equation has no solution at the poles' seasons, and the two ways it fails draw as opposite
///     fills on the chart, which a single "no times today" answer could not tell apart.
/// </remarks>
public enum SunState
{
	...
	/// <summary>The sun stays above the angle all day: midnight sun at the official zenith, a white night at the civil one.</summary>
	AlwaysAbove,

	/// <summary>The sun stays below the angle all day: polar night at the official zenith, deeper than civil twilight at the civil one.</summary>
	AlwaysBelow
}

/// <summary>The sun's behaviour on one day at one zenith angle, with the crossing times in local time.</summary>
...
/// <summary>Sunrise and sunset for any day of the year, dependency-free, via the NOAA equations.</summary>
/// <remarks>
