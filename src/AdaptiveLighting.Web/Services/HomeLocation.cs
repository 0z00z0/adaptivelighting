...
/// <summary>Reads the house's latitude and longitude from Home Assistant's <c>zone.home</c>, for the chart.</summary>
/// <remarks>
///     With <c>zone.home</c> unreadable, <see cref="TryRead"/> answers <c>null</c> and the chart shows a note in
///     place of a guessed location.
/// </remarks>
