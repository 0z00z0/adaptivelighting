...
/// <summary>The id of every glyph <c>IconSprite</c> defines, named once so nothing has to spell one out.</summary>
/// <remarks>
///     A mistyped <c>&lt;use href="#i-atuo"&gt;</c> renders nothing: no exception, no console message, just a
///     blank where an icon should be. Constants turn that into a compile error.
/// </remarks>
