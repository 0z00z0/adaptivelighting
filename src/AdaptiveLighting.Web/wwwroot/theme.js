/*
	...
	A file, not an inline <script>: it matches how this library already ships app.css, it costs nothing
	...
	AppThemes in C#, so the ids a browser may hold have one definition.
*/
(function () {
	'use strict';
