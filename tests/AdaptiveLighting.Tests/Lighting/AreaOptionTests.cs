...
public sealed class AreaOptionTests
{
	...
	{
		AreaOption option = new AreaOption("stue", "Stue", LightCount: 1, MotionCount: 1, LuxCount: 1);
	...
	{
		AreaOption option = new AreaOption("tilbygg", "tilbygg", LightCount: 2, MotionCount: 0, LuxCount: 0);
	...
	{
		AreaOption option = new AreaOption("bod", "Bod", LightCount: 0, MotionCount: 3, LuxCount: 1);
