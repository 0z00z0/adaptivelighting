...
/// <summary><see cref="TimePeriodConfig.StartsOnMotion"/>: a period that does not begin at its <c>Start</c>, what movement does to it, and the three bounds on it.</summary>
[TestClass]
public sealed class MotionPeriodTests
{
	...
	// The boundary going by is not the period beginning.
	[TestMethod]
