...
/// <summary>What the commissioning board's one commit does to a document, and mostly what it does not.</summary>
/// <remarks>An unanswered sheet leaves the document byte-identical, so nearly every test here asserts an absence.</remarks>
[TestClass]
