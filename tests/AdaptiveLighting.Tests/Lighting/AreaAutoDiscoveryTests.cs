...
public sealed class AreaAutoDiscoveryTests
{
	...
	// Regression: the shipped default was once a placeholder-filled example. Every REPLACE_ME id named an
	// entity HA did not know, so a new installation started with errors and refused to run.
	[TestMethod]
