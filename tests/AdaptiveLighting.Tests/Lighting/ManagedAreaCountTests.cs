...
/// <summary>
///     The denominator of "n of m rooms are running". An area switched off was never a candidate, so counting it
///     made the figure read as a fault that was not one.
/// </summary>
/// <remarks>
///     Petterhaugen is the worked example: a whole-cabin area holding no lights of its own, switched off on
///     purpose. It reported "2 of 4" where three areas were ever meant to run, and raised an error and a Home
///     Assistant notification on every start.
/// </remarks>
[TestClass]
public sealed class ManagedAreaCountTests
{
	...
	/// <summary>Saying nothing means running, which is what every document written before the flag existed says.</summary>
	[TestMethod]
