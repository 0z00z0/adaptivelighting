...
/// <summary>How a value is written into a sentence, and how it comes back.</summary>
[TestClass]
public sealed class TokenFormatTests
{
	...
	// nb-NO writes decimals with a comma: follow the current culture and "0,5" parses back as five, sending the warning dim to 500 %.
	[TestMethod]
