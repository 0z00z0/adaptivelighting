...
/// </summary>
/// <remarks>
///     Enough to construct the orchestrator without HassModel's Area and EntityRegistration, whose constructors
///     are not public. Tests with explicit light and motion lists never reach the registry.
/// </remarks>
