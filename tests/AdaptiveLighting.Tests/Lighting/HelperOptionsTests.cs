...
/// <summary>Reconciling a Home Assistant dropdown against the rows a document stores for it.</summary>
/// <remarks>An unanswered connection must not read as a helper whose options have all been deleted.</remarks>
[TestClass]
