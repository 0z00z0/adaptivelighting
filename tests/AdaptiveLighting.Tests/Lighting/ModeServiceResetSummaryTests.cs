...
/// <summary>
///     The reset sentence each house-mode card carries. Under Home Assistant's authority the engine stands the
///     reset triggers down, so the card must not keep promising them.
/// </summary>
[TestClass]
