...
/// <summary>
///     The move off user-typed names: a period and a house-mode option each get an id, every reference inside the
///     document points at that id, and a document written before ids is migrated exactly once.
/// </summary>
[TestClass]
