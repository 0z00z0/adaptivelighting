...
/// <summary>The classes that actually talk to Home Assistant: the wire format, and the calls not made.</summary>
/// <remarks>A misspelled <c>brightness_pct</c> compiles, throws nothing, and leaves a light quietly ignoring the engine.</remarks>
[TestClass]
