...
/// <summary>
///     The one object <see cref="ModeMonitor"/> writes and every area's <see cref="CircadianCalculator"/> reads.
/// </summary>
[TestClass]
public sealed class MotionPeriodLatchTests
{
	...
	// Nothing outside the held set is ever held back, whatever gets written about it.
	[TestMethod]
